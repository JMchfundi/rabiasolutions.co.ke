    ...
    <div >
      ...
      <div className="overflow-hidden mb-5" style={{ height: "75vh" }}>
        {slides.map((slide, index) => (
          <div
            key={index}
            className="position-absolute top-10 start-0 w-100 h-100"
            style={{
      ...
      {/* ABOUT SECTION */}
      <div className="container-fluid py-5 px-5 text-center">
        <h2 className="fw-bold mb-3">Helping the Community</h2>
        <p className="lead col-lg-8 mx-auto">
          We are a team of financial experts, agricultural advisors, and community developers working together to uplift farmers and improve livelihoods.
        </p>
      </div>
      ...
      <div className="container-fluid py-5 px-5 bg-light">
        ...
        <div className="row g-4 justify-content-center">
          ...
          {[
            { icon: <FaMoneyBillWave size={28} />, title: "Elimu Loan", text: "Education-related expenses such as school fees, uniforms, and books.", color: "primary" },
            { icon: <FaExclamationTriangle size={28} />, title: "Emergency Loan", text: "Immediate relief loans for unforeseen emergencies.", color: "success" },
            { icon: <FaTint size={28} />, title: "Drip Kits", text: "Modern drip irrigation kits to maximize water usage.", color: "warning" }
          ].map((service, i) => (
            <div className="col-md-4 col-lg-3" key={i}>
              ...
              >
                <div className={`bg-${service.color} text-white rounded-circle d-inline-flex align-items-center justify-content-center mx-auto mt-3`} style={{ width: "60px", height: "60px" }}>
                  {service.icon}
                </div>
